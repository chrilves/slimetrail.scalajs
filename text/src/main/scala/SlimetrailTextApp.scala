...
final class SlimetrailTextApp(size: Int) extends SlimetrailApp(size) with TextApplication:
  ...
  def view(m: GameState): Msg =
    ...
    then
      ...
      val promptEndGame: String = s"Congratulations $player, you've just won the game!" ++
