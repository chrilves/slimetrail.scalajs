...
final case class Point(x: Double, y: Double):
  ...
  /** Multiplication of complex numbers In polar coordinates, with point p1 of radius r1 and angle
    * a1. And point p2 of radius r2 and angle a2. The result is of radius r1*r2 and angle a1+a2.
    */
  def *(p2: Point): Point =
    Point(
...
object Point:
  ...
  /** The 6 points of an regular hexagon of radius 1 centered at the origin. Ordered by increasing
    * angle.
    */
